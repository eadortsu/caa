...
export default {
  head() {
        return {
            title: `Login | Cocoa Abrabopa Association`
        };
    },
  layout: "auth",
  data() {
            ...
            <div class="card">
              <div class="card-body p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Sign in to continue to CAA Dashboard.</p>
                </div>
                <div class="p-2 mt-4">
                  <b-alert
                    v-model="isAuthError"
...
<!--                    <div class="mt-4 text-center">
            ...
            <div class="mt-5 text-center">
              <p class="text-white">
                © {{ new Date().getFullYear() }} CAA. Crafted with
                <i class="mdi mdi-heart text-danger"></i> by Infowell
              </p>
            </div>
            <!-- end row -->
          </div>
